        ...
        <>
            <Row>
                ...
                <Col lg={12} className="mt-4">
                        ...
                        <Container>
                            <Row>
                                ...
                                <Col lg={6} className="p-5">
                                    <h3 style={{ color: "#fff" }} className="fw-bold">Who we are</h3>
                                    <p>
                    ...
                    <div className="section-1 text-white p-3">
                        <Container>
                            <Row className="container">
                                ...
                                <Col lg={6} className="p-5">
                                    <h3 style={{ color: "#fff" }} className="fw-bold">Our History</h3>
                    ...
                    <div className="section-2 text-white p-3">
                        <Container>
                            <Row className="container">
                                ...
                                <Col lg={6} className="p-5">
                                    <h3 style={{ color: "#fff" }} className="fw-bold">Our Accreditations</h3>
                                    <p>
