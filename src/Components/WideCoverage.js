    ...
    return (
        <>
            <Container>
                <Row className="p-5">
                    <Col lg={6}>
                        <h2 className="text-uppercase fw-bold" style={{color:'#258b41'}}>World WIDE COVERAGE</h2>
                        <h3 className="fw-bold text-black">Our Services are designed to make a difference within all sectors</h3>
                        <p>Our services include cleaning, maintenance, and security Nation wide. We are proud to be delivering across the world in the following industries:</p>
                        <img className="rounded mb-3" src={wideservice} width="100%" />
                    </Col>
                    <Col lg={6}>
